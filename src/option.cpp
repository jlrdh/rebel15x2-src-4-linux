...
static option_t Option[] = {
   ...
   { "NNUE Tuner", true, "70", "spin", "min 25 max 200", NULL },
...
//   { "Hash Pruning", false, "true", "check", "", NULL },
...
//   { "Hash Pruning Margin",   true, "100",   "spin",  "min 0 max 1000", NULL },
   ...
   { "Delta Margin",  true, "200",    "spin",  "min 0 max 999", NULL },
   ...
   { "Threads",   true, "1",   "spin",  "min 1 max 64", NULL },
